...
out = FOREACH foo GENERATE datafu.pig.text.opennlp.TokenizeME(text) AS tokens;
DUMP out
...
out3 = FOREACH out25 GENERATE datafu.pig.text.opennlp.TokenizeME(sentences) AS tokens;
DUMP out3
