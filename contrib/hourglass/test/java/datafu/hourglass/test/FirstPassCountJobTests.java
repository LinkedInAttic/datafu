...
@Test(groups="pcl")
public class FirstPassCountJobTests extends TestBase
{
  private Logger _log = Logger.getLogger(FirstPassCountJobTests.class);
  ...
  public FirstPassCountJobTests() throws IOException
  {
    super();
  }
